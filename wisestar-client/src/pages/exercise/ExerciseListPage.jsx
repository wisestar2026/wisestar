/**
 * [已废弃] ExerciseListPage.jsx - 原「习题列表页（知识树 × 练习总览）」
 *
 * 自 2026-09-08 起 /exercise/list 已被「教研平台 TeachingResearchPlatformPage」整体替换，
 * 本文件不再被 App.jsx 引用，保留仅作历史参考，新功能请勿再依赖本页组件。
 *
 * 历史功能: 知识树下钻、练习绑定维护、学员端刷题预览（已由知识管理各页承接）
 * URL: /exercise/list（习题管理 → 习题列表，已改菜单名「教研平台」）
 *
 * 历史功能（原需求清单）:
